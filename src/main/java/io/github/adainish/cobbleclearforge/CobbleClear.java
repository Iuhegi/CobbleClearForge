...
public class CobbleClear implements ModInitializer {
    ...
    public void onCommandRegistry(CommandDispatcher<CommandSourceStack> dispatcher, CommandBuildContext buildContext, Commands.CommandSelection commandSelection) {
    ...
    public void onInitialize() {
        ...
        CommandRegistrationCallback.EVENT.register(this::onCommandRegistry);
    }
}
